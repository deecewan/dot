  ...
  let s:guishade1 = "#383838"
  let s:guishade2 = "#555455"
  let s:guishade3 = "#727172"
  let s:guishade4 = "#8f8e90"
  let s:guishade5 = "#acabad"
  let s:guishade6 = "#c9c7ca"
  let s:guishade7 = "#e6e4e7"
  let s:guiaccent0 = "#fb2429"
  let s:guiaccent1 = "#fa49d6"
  let s:guiaccent2 = "#f7772a"
  let s:guiaccent3 = "#3bea4f"
  let s:guiaccent4 = "#00ebb6"
  let s:guiaccent5 = "#00b0ec"
  let s:guiaccent6 = "#e4e700"
  let s:guiaccent7 = "#a264f4"
  ...
  let s:ctermaccent1 = 206
  let s:ctermaccent2 = 209
  let s:ctermaccent3 = 84
  let s:ctermaccent4 = 50
  let s:ctermaccent5 = 39
  let s:ctermaccent6 = 190
  let s:ctermaccent7 = 141
